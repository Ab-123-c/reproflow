...
In `v0.1.0`, selection can use the bug report itself as an **untrusted relevance hint**. The issue text never becomes an instruction and it never causes repository code to execute.
