...
`reproflow/v1` keeps `nonzero_exit` as an explicit broad matcher, while v0.1.2 hardens the two failure types that are most likely to produce false positives:
