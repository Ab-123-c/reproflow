...
`reproflow/v1` keeps `nonzero_exit` as an explicit broad matcher, while v0.1.3 hardens the two failure types that are most likely to produce false positives:
